    ...
    connectedCallback() {
        ...
        <header>
            <div id="headerNavigation">
                <a href="index" class="nav-button" id="header-nav-home">Home</a>
                <a href="messages" class="nav-button" id="header-nav-messages">Messages</a>
                <a href="about" class="nav-button" id="header-nav-about">About</a>
            </div>
        </header>
    `;
    }
